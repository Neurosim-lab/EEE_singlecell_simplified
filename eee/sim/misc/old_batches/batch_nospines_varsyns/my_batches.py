...
# Varying number of syns (1D batch)
batch = {}
batch["label"] = "numsyns"
batch["cfgFile"] = "cfg.py"
batch["netParamsFile"] = "netParams.py"
params = OrderedDict()
params["numsyns"] = [1, 5, 10, 50, 100, 200]
batch["params"] = params
batches[batch["label"]] = batch
...
if __name__ == '__main__':
	...
	stop = time.time()
	print
	print("Completed eee/sim/batches/batch_nospines_varsyns/my_batches.py")
